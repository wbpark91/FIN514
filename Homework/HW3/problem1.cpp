...
int main(int argc, char **argv) {
    ...
    for (int i = 1; i <= 20; ++i) {
        ...
        double rbExtraValue = extrapolate<double>(i * stepSize1, rbValue1, 2 * i * stepSize1, rbValue2);
    ...
    for (int i = 1; i <= 10; ++i) {
        ...
        double lrExtraValue = extrapolate<double>(i * stepSize2 + 1, lrValue1, 2 * i * stepSize2 - 1, lrValue2, 2);
